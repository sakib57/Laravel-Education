      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <!--Feature-->
            <li>
              <a href="#"><i class="fa fa-circle-o"></i> Features
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i> Title</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Description</a></li>
                <li>
                  <a href="#"><i class="fa fa-circle-o"></i> Level Two
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
            ...
            <!--Info-->
            <li>
              <a href="#"><i class="fa fa-circle-o"></i> Info
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
            ...
            <!--Course mission-->
            <li>
              <a href="#"><i class="fa fa-circle-o"></i> Course Mission
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i> Title</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Description</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Video Url</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Success</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Info</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Danger</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Warning</a></li>
                <li>
                  <a href="#"><i class="fa fa-circle-o"></i> Level Two
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
            ...
            <!--Review-->
            <li>
              <a href="#"><i class="fa fa-circle-o"></i> Review
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i> All Review</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Published Review</a></li>
                <li>
                  <a href="#"><i class="fa fa-circle-o"></i> Level Two
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
              <a href="#"><i class="fa fa-circle-o"></i> Upcoming Events
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <!--End Banner-->
            <li><a href="#"><i class="fa fa-circle-o"></i> Add Events</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-share"></i> <span>Gallery</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <!--End Banner-->
            <li><a href="#"><i class="fa fa-circle-o"></i> Add Image</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Manage Images</a></li>
          </ul>
        </li>
