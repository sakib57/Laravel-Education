		  ...
		  <header id="header" id="home">
			  		...
			  		<div class="row">
                        ...
                        @else
                            <li class="nav-item dropdown float-right" style="list-style:none;">
                                ...
                                <div style="background-color: gray" class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a style="color: white;padding: 15px" class="" href="{{ route('user.logout') }}">
                                        {{ __('Logout') }}
                                    </a>
                                </div>
                            </li>
		    ...
		    <div class="container main-menu">
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
			        <a href="{{route('home')}}"><img src="../frontend/img/logo.png" alt="" title="" /></a>
			      </div>
